...
fin   = '%s/Results/neural_nets/params_2_SFRH/SIMBA/results/1hd_1000_0.0_5e-5_1P.txt'%root
f_out = 'SFRH_NN_1parameter_SIMBA.pdf'
...
for ax in [ax1,ax2]:
    ax.set_ylabel(r'${\rm SFRD}\,[M_\odot{\rm yr^{-1}}{\rm Mpc}^{-3}]$',fontsize=18)
...
ax3.text(0.07, 0.07, r'$A_{\rm SN1}$', fontsize=22, color='k', transform=ax3.transAxes)
ax4.text(0.07, 0.07, r'$A_{\rm AGN1}$', fontsize=22, color='k', transform=ax4.transAxes)
ax5.text(0.07, 0.07, r'$A_{\rm SN2}$', fontsize=22, color='k', transform=ax5.transAxes)
ax6.text(0.07, 0.07, r'$A_{\rm AGN2}$', fontsize=22, color='k', transform=ax6.transAxes)
