# This script plots the median/16-84 percentiles from LH vs CV
from pylab import *
import numpy as np
...
ax12.plot(X,Y2m,c=c1,linestyle='-')
...
ax12.plot(X,Y2m,c=c2,linestyle='--')
##################################
...
#legend
ax1.legend([p1,p2],
           [r"${\rm IllustrisTNG\,\,LH}$",
            r"${\rm IllustrisTNG\,\,CV}$"],
           loc=8,prop={'size':14},ncol=1,frameon=True)
