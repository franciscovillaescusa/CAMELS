...
**June 2026:** A new set of 1,192 second-generation IllustrisTNG simulations has been added to CAMELS. These simulations are run in :math:`(50~h^{-1}{\rm Mpc})^3` boxes (eight times the volume of first-generation CAMELS) with :math:`512^3` dark matter and gas particles, and explore a 35-dimensional parameter space comprising 5 cosmological and 30 astrophysical parameters. The release includes the SB35 set (1,024 simulations in a Sobol sequence), a 1P set (141 simulations varying one parameter at a time), and a CV set (27 simulations). The 35 parameters include all 28 from the first-generation SB28 set, plus 7 new parameters controlling the UV background amplitude and timing, the SNIa rate, and the gravitational softening length. See :ref:`params` for details. This release accompanies `Genel et al. (2026) <https://arxiv.org/abs/2606.10038>`__.
